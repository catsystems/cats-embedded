...
// CATS customization: prefer runtime DFU when the core enables both DFU modes.
...
void tud_dfu_runtime_reboot_to_dfu_cb(void) {
  // CATS customization: the installed TinyUF2 bootloader recognizes this
  // application reset hint and exposes the UF2 update drive.
  constexpr uint16_t APP_REQUEST_UF2_RESET_HINT = 0x11F2;
