...
struct SelfTestProfile {
  ...
  static constexpr uint32_t kMinimumPacketsPerSecond = 5;
  static constexpr uint32_t kMaximumGapMs = 1500;
  static constexpr uint32_t kMinimumMeanLq = 50;
};
