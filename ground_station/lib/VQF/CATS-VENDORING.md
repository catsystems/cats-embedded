...
The previous Madgwick vendor folder was removed after this migration; its CATS
delta remains available in repository history. VQF is the only attitude filter
included and linked by the GS. Real-filter integration tests run in
