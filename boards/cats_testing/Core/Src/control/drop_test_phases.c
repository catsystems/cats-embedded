...
void check_dt_idle_phase(drop_test_fsm_t *fsm_state, dt_telemetry_trigger_t *dt_telemetry_trigger);
void check_dt_waiting_phase(drop_test_fsm_t *fsm_state, imu_data_t *imu_data,
                            dt_telemetry_trigger_t *dt_telemetry_trigger);
void check_dt_drogue_phase(drop_test_fsm_t *fsm_state, dt_telemetry_trigger_t *dt_telemetry_trigger);
