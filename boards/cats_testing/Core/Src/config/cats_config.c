...
void cc_set_clear_flash(bool clear_flash) { global_cats_config.clear_flash = clear_flash; }
...
void cc_print() {
  ...
  log_info("Boot State: %s, Clear Flash: %hu", BOOT_STATE_STRING[global_cats_config.boot_state],
