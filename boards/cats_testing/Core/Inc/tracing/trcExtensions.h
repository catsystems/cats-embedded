...
#define TRC_EXTENSIONS_DATA                                                                                    \
  {                                                                                                            \
    {                                                                                                          \
      TRC_EXTENSION_EVENTCODE_BASE, TRC_EXTENSION_EVENTCODE_BASE + TRC_EXT1_COUNT - 1, TRC_EXT1_VERSION_PATCH, \
          TRC_EXT1_VERSION_MINOR, TRC_EXT1_VERSION_MAJOR, TRC_EXT1_NAME                                        \
    }                                                                                                          \
  }
#endif
...
#define TRC_EXTENSIONS_DATA                                                                           \
  {                                                                                                   \
    {TRC_EXTENSION_EVENTCODE_BASE, TRC_EXTENSION_EVENTCODE_BASE + TRC_EXT1_COUNT - 1,                 \
    ...
    {                                                                                                 \
      TRC_EXTENSION_EVENTCODE_BASE + TRC_EXT1_COUNT,                                                  \
          TRC_EXTENSION_EVENTCODE_BASE + TRC_EXT1_COUNT + TRC_EXT2_COUNT - 1, TRC_EXT2_VERSION_PATCH, \
          TRC_EXT2_VERSION_MINOR, TRC_EXT2_VERSION_MAJOR, TRC_EXT2_NAME                               \
    }                                                                                                 \
  }
#endif
  ...
  {                                                                                                                    \
    ...
    {                                                                                                                  \
      TRC_EXTENSION_EVENTCODE_BASE + TRC_EXT1_COUNT + TRC_EXT2_COUNT,                                                  \
          TRC_EXTENSION_EVENTCODE_BASE + TRC_EXT1_COUNT + TRC_EXT2_COUNT + TRC_EXT3_COUNT - 1, TRC_EXT3_VERSION_PATCH, \
          TRC_EXT3_VERSION_MINOR, TRC_EXT3_VERSION_MAJOR, TRC_EXT3_NAME                                                \
    }                                                                                                                  \
  }
#endif
#if (TRC_CFG_EXTENSION_COUNT == 4)
  ...
  {                                                                                                             \
    ...
    {                                                                                                           \
      TRC_EXTENSION_EVENTCODE_BASE + TRC_EXT1_COUNT + TRC_EXT2_COUNT + TRC_EXT3_COUNT,                          \
          ...
          TRC_EXT4_VERSION_PATCH, TRC_EXT4_VERSION_MINOR, TRC_EXT4_VERSION_MAJOR, TRC_EXT4_NAME                 \
    }                                                                                                           \
  }
#endif
...
#define TRC_EXTENSION_INFO                                                                     \
  {                                                                                            \
    TRC_CFG_EXTENSION_COUNT, TRC_EXTENSION_EVENTCODE_BASE, ROUNDUP4(TRC_CFG_EXT_MAX_NAME_LEN), \
        sizeof(PSFExtensionEntryType), TRC_EXTENSIONS_DATA                                     \
  }
#else
#define TRC_EXTENSION_INFO \
