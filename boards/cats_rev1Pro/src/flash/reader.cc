...
void dump_recording(uint16_t number) {
  ...
  char *string_buffer1 = static_cast<char *>(calloc(400, sizeof(char)));
  char *string_buffer2 = static_cast<char *>(calloc(400, sizeof(char)));
  uint8_t *read_buf = static_cast<uint8_t *>(calloc(256, sizeof(uint8_t)));
