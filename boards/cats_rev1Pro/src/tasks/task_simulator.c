 ...
 * @retval None
 */
_Noreturn void task_simulator(__attribute__((unused)) void *argument) {
  ...
  while (1) {
    ...
    sim_baro_data[0].pressure = linear_interpol((float32_t)time_since_start, (float32_t)pressure_time_array[index_press], (float32_t)pressure_time_array[index_press + 1], pressure_array[index_press], pressure_array[index_press+1]);
    /* Add Noise */
