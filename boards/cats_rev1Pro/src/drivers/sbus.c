...
void map_channels(receiver_data_t* data, uint8_t* _payload) {
  ...
  data->ch[2] = (uint16_t)((_payload[2] >> 6 | _payload[3] << 2 | _payload[4] << 10) & 0x07FF);
  data->ch[3] = (uint16_t)((_payload[4] >> 1 | _payload[5] << 7) & 0x07FF);
  data->ch[4] = (uint16_t)((_payload[5] >> 4 | _payload[6] << 4) & 0x07FF);
  data->ch[5] = (uint16_t)((_payload[6] >> 7 | _payload[7] << 1 | _payload[8] << 9) & 0x07FF);
  ...
  data->ch[10] = (uint16_t)((_payload[13] >> 6 | _payload[14] << 2 | _payload[15] << 10) & 0x07FF);
  data->ch[11] = (uint16_t)((_payload[15] >> 1 | _payload[16] << 7) & 0x07FF);
  data->ch[12] = (uint16_t)((_payload[16] >> 4 | _payload[17] << 4) & 0x07FF);
  data->ch[13] = (uint16_t)((_payload[17] >> 7 | _payload[18] << 1 | _payload[19] << 9) & 0x07FF);
