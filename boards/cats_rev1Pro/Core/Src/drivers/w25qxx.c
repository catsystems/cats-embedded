...
//#define READ_ID_CMD2          0x9F         /*  Read ID command  */
...
//#define QUAD_INOUT_FAST_READ_4_BYTE_ADDR_CMD 0xEC    /* 32bit Address of the 4 Line quick read command  */
//
...
//
//    /*  Basic configuration  */
//    sCommand.InstructionMode = QSPI_INSTRUCTION_1_LINE;        /* 1 Send instructions in line mode  */
//    sCommand.AddressSize = QSPI_ADDRESS_32_BITS;          /* 32 Bit address  */
//    sCommand.AlternateByteMode = QSPI_ALTERNATE_BYTES_NONE;      /*  No alternate bytes  */
//    sCommand.DdrMode = QSPI_DDR_MODE_DISABLE;          /* W25Q256JV I won't support it DDR */
//    sCommand.DdrHoldHalfCycle = QSPI_DDR_HHC_ANALOG_DELAY;      /* DDR Pattern , Data output delay  */
//    sCommand.SIOOMode = QSPI_SIOO_INST_EVERY_CMD;        /*  Every time it's transmitted, it's going to send instructions  */
//
//    /*  Reading data  */
//    sCommand.Instruction = QUAD_INOUT_FAST_READ_4_BYTE_ADDR_CMD; /* 32bit Address of the 4 Line quick read command  */
//    sCommand.DummyCycles = 6;                    /*  Empty period  */
//    sCommand.AddressMode = QSPI_ADDRESS_4_LINES; /* 4 Line address  */
//    sCommand.DataMode = QSPI_DATA_4_LINES;    /* 4 Line data  */
//    sCommand.NbData = _uiSize;              /*  The size of the data read  */
//    sCommand.Address = _uiReadAddr;          /*  The starting address for reading data  */
//
//    /* TODO: reduce timeout */
...
//    sCommand.DdrMode           = QSPI_DDR_MODE_DISABLE;      /* W25Q256JV I won't support it DDR */
//    sCommand.DdrHoldHalfCycle  = QSPI_DDR_HHC_ANALOG_DELAY;  /* DDR Pattern , Data output delay  */
//    sCommand.SIOOMode          = QSPI_SIOO_INST_ONLY_FIRST_CMD;     /*  Send the command only once  */
//
//    /*  Write sequence configuration  */
//    sCommand.Instruction = QUAD_IN_FAST_PROG_4_BYTE_ADDR_CMD; /* 32bit Address of the 4 Line quick write command  */
//    sCommand.DummyCycles = 0;                    /*  You don't need an empty period  */
//    sCommand.AddressMode = QSPI_ADDRESS_1_LINE;  /* 4 Line address mode  */
//    sCommand.DataMode    = QSPI_DATA_4_LINES;    /* 4 Line data mode  */
//    sCommand.NbData      = _usWriteSize;         /*  Write data size  */
//    sCommand.Address     = _uiWriteAddr;         /*  Write address  */
//
//    if (HAL_QSPI_Command(&hqspi, &sCommand, 10000) != HAL_OK)
//    {
//        //return 0;
