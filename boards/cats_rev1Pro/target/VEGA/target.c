...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, BARO_Pin|IMU_Pin|PYRO_EN_Pin|FLASH_CS_Pin
                               |IO1_Pin|PYRO1_Pin|PYRO2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BARO_Pin IMU_Pin PYRO_EN_Pin FLASH_CS_Pin
                           IO1_Pin PYRO1_Pin PYRO2_Pin */
  GPIO_InitStruct.Pin = BARO_Pin|IMU_Pin|PYRO_EN_Pin|FLASH_CS_Pin
                        |IO1_Pin|PYRO1_Pin|PYRO2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = RF_INT1_Pin|USB_DET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
