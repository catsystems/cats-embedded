...
void vTaskStateEst(void *argument) {
	...
	while (1) {
		...
		state_data.acceleration[0] = (float)(global_imu[0].acc_z)/(1024)*9.81f - 9.81f;
		state_data.acceleration[1] = (float)(global_imu[1].acc_z)/(1024)*9.81f - 9.81f;
		state_data.acceleration[2] = (float)(global_imu[2].acc_z)/(1024)*9.81f - 9.81f;
