...
#define REG_LR_FIRMWARE_VERSION_MSB \
  0x0153  // The address of the register holding the firmware version MSB
...
typedef enum {
  ...
  SX1280_LORA_PACKET_FIXED_LENGTH = 0x80,     //!< The packet is known on both sides, no header
