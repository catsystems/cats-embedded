...
void TinyGPSLocation::setLatitude(const char *term) { TinyGps::parseDegrees(term, rawNewLatData); }

void TinyGPSLocation::setLongitude(const char *term) { TinyGps::parseDegrees(term, rawNewLngData); }
...
void TinyGPSTime::setTime(const char *term) { newTime = (uint32_t)TinyGps::parseDecimal(term); }
...
void TinyGPSDecimal::set(const char *term) { newval = TinyGps::parseDecimal(term); }
